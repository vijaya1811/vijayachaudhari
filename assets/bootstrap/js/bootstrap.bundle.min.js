...
!(function (e, t) {
                    ...
                    return (
                        ...
                        (a._jQueryInterface = function (i) {
                            return this.each(function () {
                                ...
                                if (
                                    (!t && n.toggle && /show|hide/.test(i) && (n.toggle = !1), t || ((t = new a(this, n)), e.data(ae, t)), "string" == typeof i)
                                ) {
    ...
    function We(e) {
        ...
        return i && "BODY" !== i && "HTML" !== i
            ? -1 !== ["TD", "TABLE"].indexOf(n.nodeName) && "static" === Pe(n, "position")
                ? We(n)
                : n
            : e
    ...
    function $e(e, t, n, i) {
        ...
        if ("viewport" === i)
            ...
            var a = void 0;
            "scrollParent" === i
                ? "BODY" === (a = je(Le(t))).nodeName && (a = e.ownerDocument.documentElement)
                            ...
                            f = {
                                ...
                                secondary: function (e) {
                                    var t = "right" === e ? "left" : "top",
                                        n = u[t];
                                    return (
                                        u[e] > l[e] && !i.escapeWithReference && (n = Math.min(u[t], l[e] - ("right" === e ? u.width : u.height))), Ve({}, t, n)
                                    );
                                },
                            };
                        return (
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        return (
                            ...
                            (e.arrowElement = i),
                            (e.offsets.arrow = (Ve((n = {}), f, Math.round(y)), Ve(n, h, ""), n)),
                            e
                        );
                    },
                    element: "[x-arrow]",
                        ...
                        return (
                            E.forEach(function (e, t) {
                                ...
                                var n,
                                    ...
                                    d =
                                        !!m.flipVariations &&
                                        ((h && "start" === y && a) || (h && "end" === y && l) || (!h && "start" === y && c) || (!h && "end" === y && u));
                                (s || f || d) &&
                                    ((p.flipped = !0),
                                    (s || f) && (_ = E[t + 1]),
                ...
                return (
                    ...
                    (e._getPopperConfig = function () {
                        ...
                        var n = {
                            ...
                            modifiers: { offset: e, flip: { enabled: this._config.flip }, preventOverflow: { boundariesElement: this._config.boundary } },
                        };
                    ...
                    (c._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName)
                                ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || Tt(e.target).closest(Ut).length)))
                                : Nt.test(e.which)) &&
                ...
                return (
                    ...
                    (e._enter = function (e, t) {
                        ...
                        (t = t || yn(e.currentTarget).data(n)) ||
                            ((t = new this.constructor(e.currentTarget, this._getDelegateConfig())), yn(e.currentTarget).data(n, t)),
                    ...
                    (e._getConfig = function (e) {
                        return (
                            "number" == typeof (e = l({}, this.constructor.Default, yn(this.element).data(), "object" == typeof e && e ? e : {})).delay &&
                    ...
                    (e._fixTransition = function () {
                        ...
                        null === e.getAttribute("x-placement") &&
                            (yn(e).removeClass(xn), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = t));
                    }),
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                        ...
                        if ((this._scrollHeight !== t && this.refresh(), n <= e)) {
                            ...
                            for (var r = this._offsets.length; r--; ) {
                                this._activeTarget !== this._targets[r] &&
                                    e >= this._offsets[r] &&
                                    ("undefined" == typeof this._offsets[r + 1] || e < this._offsets[r + 1]) &&
            ...
            (Ui = (function () {
                ...
                return (
                    (e.show = function () {
                        ...
                        if (
                            !(
                                (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Ti(this._element).hasClass(Ni)) ||
